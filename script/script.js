...
// Make mytwocents modal for project go from 0 height and width to full page
const goModalMyTwoCents = () => {
  $('#mytwocentsModal').css({ display: 'block' });
  $('.mytwocentsImage').css({ height: '40vh', width: '45vw' });
  $('.scene-overlay-3').css({height: '0', width: '0'});
}

// Make mytwocents modal for project go from 0 height and width to full page
const goModalCfYS = () => {
  $('#cfysModal').css({ display: 'block' });
  $('.cfysImage').css({ height: '40vh', width: '45vw' });
  $('.scene-overlay-3').css({height: '0', width: '0'});
}
...
const closeModalMyTwoCents = () => {
  $('#mytwocentsModal').css({ display: 'none' });
  $('.mytwocentsImage').css({ height: '0', width: '0' });
  $('.scene-overlay-3').css({ height: '70vh', width: '70vw' });
}

// Close heyo modal on button click
const closeModalCfYS = () => {
  $('#cfysModal').css({ display: 'none' });
  $('.cfysImage').css({ height: '0', width: '0' });
  $('.scene-overlay-3').css({ height: '70vh', width: '70vw' });
}
...
// event listners
$('.modalbtnmytwocents').click(function(){ goModalMyTwoCents(); });
$('.modalbtncfys').click(function(){ goModalCfYS(); });
...
$('.x4').click(function(){ closeModalMyTwoCents(); })
$('.x5').click(function(){ closeModalCfYS(); })
});
